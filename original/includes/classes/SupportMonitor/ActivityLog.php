...
class ActivityLog {
	...
	private function get_user_meta_keys_to_log() {
		 ...
		 */
		return apply_filters( 'matchbox_fire_protection_logged_user_meta_changes', $user_meta_keys_to_log );
	}
	...
	private function get_option_changes_to_log() {
		 ...
		 */
		return apply_filters( 'matchbox_support_monitor_logged_option_changes', $options_to_log );
	}
